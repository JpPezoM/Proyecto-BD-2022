...
cur.execute("CREATE TABLE noticia(idNoticia VARCHAR(100) PRIMARY KEY, url VARCHAR(2048), nombreMedio VARCHAR(100), fecha DATE, titulo VARCHAR(100), contenido TEXT, FOREIGN KEY (nombreMedio) REFERENCES medioPrensa(nombre))")
